...
db = new Db('patientdb', server, {safe: true});
...
db.open(function(err, db) {
    if(!err) {
        ...
        console.log("unable to connect to mongodb, check to see that mongodb is started")
    }
});
...
var populateDB = function() {
    ...
    var patients = [
    {
        ...
        description: "The aromas of fruit and spice give one a hint of the light drinkability of this lovely patient, which makes an excellent complement to fish dishes.",
    ...
    },
    {
        ...
        country: "Spain",
        region: "Rioja",
        description: "A resurgence of interest in boutique vineyards has opened the door for this excellent foray into the dessert patient market. Light and bouncy, with a hint of black truffle, this patient will not fail to tickle the taste buds.",
    ...
    },
    {
        ...
        description: "The cache of a fine Cabernet in ones patient cellar can now be replaced with a childishly playful patient bubbling over with tempting tastes of black cherry and licorice. This is a taste sure to transport you back in time.",
    ...
    },
    {
        ...
        country: "USA",
        region: "Oregon",
        description: "One cannot doubt that this will be the patient served at the Hollywood award shows, because it has undeniable star power. Be the first to catch the debut that everyone will be talking about tomorrow.",
    ...
    },
    {
        ...
        country: "Italy",
        region: "Tuscany",
        description: "Though soft and rounded in texture, the body of this patient is full and rich and oh-so-appealing. This delivery is even more impressive when one takes note of the tender tannins that leave the taste buds wholly satisfied.",
    ...
    },
    {
        ...
        country: "France",
        region: "Bordeaux",
        description: "Though dense and chewy, this patient does not overpower with its finely balanced depth and structure. It is a truly luxurious experience for the senses.",
    ...
    },
    {
        ...
        country: "France",
        region: "Bordeaux",
        description: "The light golden color of this patient belies the bright flavor it holds. A true summer patient, it begs for a picnic lunch in a sun-soaked vineyard.",
        picture: "bouscat.jpg"
    },
    {
        name: "BLOCK NINE",
        ...
        country: "USA",
        region: "California",
        description: "With hints of ginger and spice, this patient makes an excellent complement to light appetizer and dessert fare for a holiday gathering.",
    ...
    },
    {
        ...
        country: "USA",
        region: "Oregon",
        description: "Though subtle in its complexities, this patient is sure to please a wide range of enthusiasts. Notes of pomegranate will delight as the nutty finish completes the picture of a fine sipping experience.",
    ...
    },
    {
        ...
        country: "Argentina",
        region: "Mendoza",
        description: "Solid notes of black currant blended with a light citrus make this patient an easy pour for varied palates.",
    ...
    },
    {
        ...
        country: "USA",
        region: "California",
        description: "Keep an eye out for this patientry in coming years, as their chardonnays have reached the peak of perfection.",
        picture: "shafer.jpg"
    },
    {
        name: "PONZI",
    ...
    },
    {
        ...
        country: "France",
        region: "Alsace",
        description: "Fresh as new buds on a spring vine, this dewy offering is the finest of the new generation of pinot grigios.  Enjoy it with a friend and a crown of flowers for the ultimate patient tasting experience.",
        picture: "hugel.jpg"
    },
    {
    ...
    },
    {
        ...
        country: "New Zealand",
        region: "South Island",
        description: "Best served chilled with melon or a nice salty prosciutto, this sauvignon blanc is a staple in every Italian kitchen, if not on their patient list.  Request the best, and you just may get it.",
        picture: "momo.jpg"
    },
    {
        name: "WATERBROOK",
